...
urlpatterns = [
    ...
    # officer feedbacks url
    path('officer_feedback_list/',views.officer_feedback_list,name='officer_feedback_list'),
path('officer_feedback_replay/',views.officer_feedback_replay,name='officer_feedback_replay'),
]
